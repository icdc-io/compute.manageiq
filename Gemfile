...
group :amazon, :manageiq_default do
  ...
  gem "amazon_ssa_support",                          :require => false, :git => "https://github.com/ManageIQ/amazon_ssa_support.git", :commit => "7486e7f" # Temporary dependency to be moved to manageiq-providers-amazon when officially release
end
